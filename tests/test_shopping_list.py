...
class TestUserShopping(unittest.TestCase):
    ...
    def test_usert_create_shopping_list(self):
        self.assertTrue(self.user.create_shopping_list(self.hopping))

    def test_user_shopping_list_exists(self):
        self.user.shopping_lists = {"AZXDJSA": self.shopping}
        self.assertFalse(self.user.create_shopping_lists(self.shopping))
